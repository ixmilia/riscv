namespace IxMilia.RiscV
{
    public interface IInstructionRV32I
    {
        ...
        public static IInstructionRV32I Parse(string s)
        {
            ...
            if (InstructionRV32I_I.TryParseRemainder(instructionName, remainder, out var iResult))
            {
                return iResult;
            }
            ...
            if (InstructionRV32I_R.TryParseRemainder(instructionName, remainder, out var rResult))
            {
                return rResult;
            }
            ...
            if (InstructionRV32I_U.TryParseRemainder(instructionName, remainder, out var uResult))
            {
                return uResult;
            }
